  ...
  const renderItem = ({ item }: any) => (
    <View style={styles.card}>
      ...
      <View style={styles.cardFooter}>
        <Text style={styles.dateText}>Generated on: {new Date(item.createdAt).toLocaleDateString()}</Text>
      </View>
    </View>
  );
  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList
        ...
        ListHeaderComponent={<Text style={styles.sectionTitle}>Recent Commissions</Text>}
...
const styles = StyleSheet.create({
  ...
  summaryBox: { backgroundColor: '#2196F3', padding: 25, margin: 15, borderRadius: 15, alignItems: 'center', elevation: 4 },
  ...
  detailsRow: { flexDirection: 'row', justifyContent: 'space-between', paddingBottom: 15, borderBottomWidth: 1, borderBottomColor: '#eee' },
